# UnityLiteL10n
A minimal **JSON-Based** localization tool for Unity – Designed for small projects. **[v0.6.0]** This tool currently supports static text only. Variables, plurals, and advanced formatting are not implemented yet.
